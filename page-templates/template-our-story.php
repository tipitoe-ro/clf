...
<style>
  ...
  .leader-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:#4b5763}.leader-card{background:var(--ink);padding:18px;display:flex;gap:12px;align-items:center;min-height:80px}.leader-name{font-size:15px;color:#eee9df}.leader-initials{font:10px "DM Mono";color:#d4a492;border:1px solid #53606a;width:31px;height:31px;display:flex;align-items:center;justify-content:center;flex:none}
